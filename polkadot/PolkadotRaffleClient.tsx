...
export default class PolkadotRaffleClient {
  ...
  private async createBuyTicketInstruction(raffleId: string, buyer: KeyringPair) {
    // Esto se conectaría con tu contrato ink! compilado
    ...
    return this.api.tx.balances.transfer(
      this.contractAddress,
      1000000000000, // 0.1 DOT en planck units
    )
  }
